...
const constructRetrySocket = (wsImplementation, url, protocols, connectionOptions) => {
    const retrySocket = {
        ...
        connect: () => {
            retrySocket.connecting = true;
            retrySocket.instance = new retrySocket.wsImplementation(retrySocket.url, retrySocket.protocols, retrySocket.connectionOptions);

            if (retrySocket.instance.on) {
                retrySocket.instance.on('open', retrySocket.successfullyConnected);
                retrySocket.instance.on('message', retrySocket.handlers.message);
                retrySocket.instance.on('error', retrySocket.handlers.error);
                retrySocket.instance.on('close', retrySocket.reconnect);
            } else {
                retrySocket.instance.onopen = retrySocket.successfullyConnected;
                retrySocket.instance.onmessage = retrySocket.handlers.message;
                retrySocket.instance.onerror = retrySocket.handlers.error;
